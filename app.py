...
# ================================================
#   Share current journey – with reliable copy
# ================================================

if IS_CLOUD and "selected_json_file" in st.session_state:
    current_filename = st.session_state.selected_json_file

    # IMPORTANT: Use your real deployed Streamlit app URL (no trailing slash)
    APP_BASE_URL = "https://your-app-name.streamlit.app"

    # Build the full shareable URL (this includes ?journey=...)
    ...
    # Show the link for manual copy fallback
